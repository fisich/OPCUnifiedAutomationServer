...
class OPCUAServerManager:
    ...
    async def create_server(self, endpoint, server_name):
        ...
        self.server.iserver.history_manager.set_storage(HistorySQLite("Fisenko OPC UA Server.sql"))
    ...
    async def activate_historizing_for_variables(self, list_of_varibles):
        for variable in list_of_varibles:
